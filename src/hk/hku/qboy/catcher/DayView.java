...
//    protected final EventGeometry mEventGeometry;
    ...
    */
    ...
    private String[] mHourStrs = { "00", "01", "02", "03", "04", "05",
...
//        }
    ...
    private void init(Context context) {
        ...
        mCurrentTime = new Time(Time.getCurrentTimezone());
        ...
        mBaseDate = new Time(Time.getCurrentTimezone());
        ...
        for (int day = 0; day < mNumDays; day++, cell++) {
            ...
            if (mNumDays == 1) {
                ...
                if (column==Calendar.SATURDAY-1) {
                    color = mWeek_saturdayColor;
                } else if (column==Calendar.SUNDAY-1) {
                    color = mWeek_sundayColor;
                }
            }
    ...
    private void drawSelectedRect(Rect r, Canvas canvas, Paint p) {
        ...
        if (mSelectionMode != SELECTION_HIDDEN && !mSelectionAllday) {
            ...
            if (mNumDays > 1) {
                ...
                canvas.drawText("hint", r.left + EVENT_TEXT_LEFT_MARGIN,
